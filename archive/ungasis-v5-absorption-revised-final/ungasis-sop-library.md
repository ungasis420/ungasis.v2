...
<!-- ABSORBED: ai_project_os_v5 — Research to Decision -->
| 33 | Research to Decision | Prototype / decision work | Level 1 by default. Level 3 only in approved company/M365 tools. Level 4 secrets must never be pasted into AI chats. |
<!-- END ABSORBED: ai_project_os_v5 — Research to Decision -->
...
## SOP 33 - Research to Decision

**Source merge note:** Absorbed from AI Project OS v5 workflow: Research to Decision. Rewritten for UNGASIS style.

| Field | Guidance |
|---|---|
| Purpose | Turn research into a clear decision, not a pile of notes. |
| When to use | Use when research must help Mel choose something: tool, stack, workflow, price, launch step, vendor, feature, policy, or next action. |
| Tools | Browser/Web Search when current facts matter, official docs, `SOURCE_LEDGER.md`, `DECISIONS.md`, spreadsheet/table, ChatGPT or another AI reviewer. |
| Output | A decision table, facts/assumptions/uncertainty list, decision record, and approved task packet. |
| Max data level | Level 1 by default. Level 3 only inside approved company/M365 tools. Never paste Level 4 secrets into AI chats. |

### Easy Analogy: Research Is Shopping With a Budget

Research is like buying a phone. You do not read every phone article forever. You first ask: **What decision am I making?** Then you compare the few options that fit your budget, risk, and need. Then you choose and write down why.

### The Core Rule

```text
Research must serve a decision.
No decision = no endless research.
```

### When To Use This SOP

| Situation | Use this SOP? | Why |
|---|---:|---|
| Choosing between tools | Yes | Tool features, pricing, and limits can change. |
| Picking an app stack | Yes | The wrong stack can waste time. |
| Checking API/platform behavior | Yes | Official docs matter. |
| Deciding public launch readiness | Yes | More risk needs better evidence. |
| Brainstorming fun ideas | No | Too much rigor slows you down. |
| Writing a simple draft | No | A quick draft does not need a decision table. |

### Research Depth Table

Choose the smallest research depth that matches the risk.

| Risk level | Research depth | Example | Minimum evidence |
|---|---|---|---|
| Low | Quick check | Pick a note-taking format | 1-2 good sources or your own test |
| Medium | Sourced comparison | Choose between Excel, Power BI, or web app | 2-4 sources plus decision table |
| High | Decision-grade research | Pick payment tool, public launch path, legal/privacy step | Official/current sources, risk notes, approval |
| Regulated / money / legal / health | Professional review path | Tax, legal terms, medical, security claims | Official sources plus qualified review |


### Suggested Time Budget by Risk

<!-- ABSORBED: ai_project_os_v5 — Research depth by risk -->

| Risk level | Suggested time budget | Stop when |
|---|---|---|
| Low | 15-30 minutes | You have enough evidence for a reversible personal/prototype choice. |
| Medium | 1-2 hours | You compared 2-4 realistic options and know the tradeoff. |
| High | Half day plus second opinion | Official/current sources were checked and risks are visible. |
| Regulated / money / legal / health | Full research plus qualified review | A professional or official source can support the decision. |

### Steps

1. **Define the decision.** Write: `I am researching this so I can decide ____.`
2. **Choose research depth by risk.** Do not do deep research for tiny choices.
3. **Use official/current sources for fast-changing things.** This includes tools, APIs, AI models, prices, laws, platform behavior, and terms.
4. **Compare options in a decision table.** Use the same criteria for every option.
5. **Separate facts, assumptions, and uncertainty.** Do not mix proof with guesses.
6. **Record the decision in `docs/DECISIONS.md`.** If the repo uses root-level `DECISIONS.md`, use that instead.
7. **Translate to a task packet only after approval.** Research does not become build work until Mel approves.

### Decision Table Template

| Option | What it is | Pros | Cons | Cost / effort | Risk | Evidence | Fit score |
|---|---|---|---|---|---|---|---:|
| Option A |  |  |  |  |  |  | /10 |
| Option B |  |  |  |  |  |  | /10 |
| Option C |  |  |  |  |  |  | /10 |

### Facts / Assumptions / Uncertainty Table

| Type | Statement | Source or reason | Confidence | Action needed |
|---|---|---|---|---|
| Fact |  | Link/file/source name | High / Medium / Low | Keep |
| Assumption |  | Why we believe it | High / Medium / Low | Test |
| Uncertainty |  | What is missing | High / Medium / Low | Verify before relying |
...
Date: [YYYY-MM-DD]
Owner: Mel
Decision needed: [what choice is being made]
...
Only create this after approval.

```markdown
# Task Packet: [task name]

Decision source: [DECISIONS.md entry]
Goal: [one small outcome]
Scope: [what to do]
Out of scope: [what not to do]
Files likely affected: [files/folders]
Data level: [0-4]
Acceptance criteria:
- [testable result]
- [testable result]
...
- moving or charging money
```

### Safety Warning

WARNING: Do not treat AI research as final truth. For current facts, check official sources. For legal, tax, finance, medical, security, or regulated decisions, use AI to prepare questions and get qualified review.


### Common Mistakes in This SOP

<!-- ABSORBED: ai_project_os_v5 — Research-to-decision anti-patterns -->

| Mistake | Why it hurts | Better move |
|---|---|---|
| Researching without a decision question | You collect random facts and never choose | Write the decision sentence first. |
| Over-researching a low-risk choice | You waste time on something easy to reverse | Match depth to risk. |
| Trusting AI summaries for fast-changing facts | Pricing, limits, APIs, and menus may be stale | Check official/current sources. |
| Comparing too many options | More options can create analysis paralysis | Narrow to 2-4 realistic options. |
| Mixing facts and guesses | Assumptions start to look proven | Use facts / assumptions / uncertainty labels. |
| Deciding only in chat | The team re-debates the same issue later | Record the decision in `DECISIONS.md`. |
| Building before approval | Work starts before the decision is stable | Create a task packet only after approval. |

### Done Checklist

- [ ] Decision sentence is written.
- [ ] Research depth matches the risk.
- [ ] Official/current sources were checked when facts can change.
- [ ] Options are compared in a decision table.
- [ ] Facts, assumptions, and uncertainty are separated.
- [ ] Decision is recorded in `DECISIONS.md` or `docs/DECISIONS.md`.
- [ ] Mel approved before any task packet became build work.
- [ ] No secrets or sensitive data were pasted into AI chats.

### Copy-Paste Helper Prompt

```text
Act as my Research to Decision assistant.
...
- Use simple English.
- Prefer official/current sources for fast-changing facts.
- Separate facts, assumptions, and uncertainty.
- Do not turn this into a task packet until I approve the decision.

Output:
1. Decision sentence
2. Research depth needed and why
3. Source plan
4. Decision table
5. Facts / assumptions / uncertainty table
6. Recommendation
7. DECISIONS.md entry draft
8. Approval question for Mel
```
...
<!-- ABSORBED: ai_project_os_v5 — Research to Decision -->
| `TASK_PACKET.md` | Turns an approved decision into one small build/work task with scope, tests, and rollback. | Unapproved decisions, secrets, private customer data, or vague tasks. |
<!-- END ABSORBED: ai_project_os_v5 — Research to Decision -->
<!-- ADDED: mattpocock/skills absorption — Ubiquitous Language -->
...
<!-- ABSORBED: ai_project_os_v5 — Research to Decision -->
| AI Project OS v5 `research-to-decision.md` | SOP 33 Research to Decision workflow | Source file provided by user | Rewritten in UNGASIS style; not copied wholesale. |
<!-- END ABSORBED: ai_project_os_v5 — Research to Decision -->
...
<!-- ABSORBED: ai_project_os_v5 — Research to Decision QA -->
- [x] Adds SOP 33 — Research to Decision with decision-first research, risk-based depth, official/current source preference, decision table, facts/assumptions/uncertainty split, `DECISIONS.md`, and approval-before-task-packet rule.
<!-- END ABSORBED: ai_project_os_v5 — Research to Decision QA -->
...
<!-- ABSORBED: ai_project_os_v5 — Research to Decision -->
| Tools/Files | Uploaded master workflow, uploaded Playbook, AI Project OS v5 `research-to-decision.md`, official OpenAI Projects help page, generated Markdown file |
<!-- END ABSORBED: ai_project_os_v5 — Research to Decision -->
...
Version: 1.1 | Date: 2026-06-01 | Module: E3 Full SOP Library | Owner: Mel John Dimat | Status: Updated with A4 Research to Decision SOP

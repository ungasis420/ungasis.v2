...
## Corpus Check
- 1799 files · ~1,334,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26310 nodes · 28984 edges · 3568 communities (2568 shown, 1000 thin omitted)
...
## Communities (3568 total, 1000 thin omitted)
...
Cohesion: 0.05
Nodes (38): 0. Start Here: The 1-Minute Prompt Rule, 13. Common Prompt Mistakes and Fixes, 14. How to Iterate on Prompts, 16. Prompt Versioning Changelog Template, 19. Prompt Quality Checklist ✅, 1. Data Safety Before Prompting 🔐, 20. Prompt Debugging: When AI Gives a Bad Answer, 21. Source Verification Prompt (+30 more)
...
Cohesion: 0.27
Nodes (10): Core idea, First prompt, Karpathy-Style Context File Guide, Quality bar, Refresh triggers, What belongs in `LLM_CONTEXT.md`, What does not belong, Workflow (+2 more)
...
Cohesion: 0.05
Nodes (44): 11. How to Avoid Exposing Secrets and Company Data, 12. Free Hosting Options for Portfolio, 13. How to Write About Projects for LinkedIn, 14. SEO Basics for Portfolio, 15. The Portfolio Honesty Rule, 1. Why You Need a Portfolio, 2. How to Turn a Personal Tool → Portfolio Project, 3. What to Show Publicly vs. Keep Private (+36 more)
...
Cohesion: 0.07
Nodes (38): Agent Evals & Runtime Governance Module, Fast Install, First Prompt, Minimal Install, Token-Efficiency Agent OS v4.0.0, Tool Table, v3->v4: 10->12 layers, 18->24 sources, 14->22 gaps closed, UNGASIS Quick Reference Wiki Guide (+30 more)
...
Cohesion: 0.13
Nodes (17): Auto Researcher Agent, Auto-Research Loop Skill, Process, Stop conditions, Auto-Research Loop, Loop, Purpose, Quality signals (+9 more)
...
Cohesion: 0.17
Nodes (11): Agent Crew, Agent Manager Integration, Auto-Routing Rules (Always Active), Domain Language Table, File Edit Rules, GEMINI.md — Antigravity Agent Configuration, Project Identity, Read Order (+3 more)
...
Cohesion: 0.20
Nodes (10): On-Demand vs Always-On (v4), .claudeignore, Context Rot Detection, Key Additions, Layer 11: Model Routing, Layer 12: Context Budget, MAX_THINKING_TOKENS, Message Cap (+2 more)
...
Cohesion: 0.05
Nodes (43): 10. Human Approval Gates, 11. Final 30-Day Rule, 1. Your 7 Starter Actions, 2. One-Sentence Idea Formula, 3. 30-Day Roadmap Overview, 4. Stage Gates, 5. Metrics to Track, 6. Weekly Review Template (+35 more)
...
Cohesion: 0.18
Nodes (13): AGENTS.md - Universal Agent Instructions, AGENTS.md - Universal Agent Instructions (v4.0), Commands, Completion: 1.Changed files 2.Summary 3.Commands 4.Results 5.Risks 6.Rollback 7.Memory updates, Core Rules, Model Routing (v4), Never Do: Rewrite entire files for small changes | Destructive cmds without confirm | Install without asking | Filler in code mode, Project (+5 more)
...
Cohesion: 0.25
Nodes (7): 13. KNOWN ISSUES, 1. EXECUTIVE SUMMARY, 3. ARCHITECTURE — Folder Structure, Complete Handoff Document for Fresh Chat Continuation, Current JARVIS Score: 35%, The 5 Dimensions of JARVIS, UNGASIS OS v5.0 — JARVIS-Fabricator Blueprint
...
Cohesion: 0.15
Nodes (12): 11. KICKOFF PROMPTS, 13. KNOWN ISSUES, 1. EXECUTIVE SUMMARY, 3. ARCHITECTURE — Folder Structure, Complete Handoff Document for Fresh Chat Continuation, Current JARVIS Score: 35%, KICKOFF A: Continue JARVIS Upgrade (Batch 1), KICKOFF B: Start RiftCoach Development (+4 more)
...
Cohesion: 0.31
Nodes (9): Commands: Test:[TEST_COMMAND] Lint:[LINT_COMMAND] Build:[BUILD_COMMAND], Completion: 1.Changed files 2.Summary 3.Commands 4.Results 5.Risks, Core Rule: Token-efficient coding. Follow AGENTS.md., GEMINI.md - Gemini/Jules Instructions (v4.0), Project: [PROJECT_NAME] | Stack: [TECH_STACK], Read First: AGENTS.md, docs/PROJECT_BRIEF.md, docs/TASK_HANDOFF.md, Rules: Search before reads. Surgical edits. No full rewrites. No claiming untested passes., Sessions under 15-20 messages. Update docs/SESSION_SUMMARY.md at end. (+1 more)
...
Cohesion: 0.10
Nodes (19): Batch 2 (June 3, 2026) — 8 sprints, 27 files. New engines:, Batch 3 (June 3, 2026) — 10 sprints, 27 files. New: Warnings,, Batch 4 + JARVIS Complete (June 3, 2026) — 9 sprints, 27 files., Session Handoff — June 2, 2026 🖥️ PC (Sprint F4b), Session Handoff — June 2, 2026 🖥️ PC (Sprint F5), Session Handoff — June 2, 2026 🖥️ PC (Sprint F6), Session Handoff — June 2, 2026 🖥️ PC (Sprint F7), Session Handoff — June 2, 2026 🖥️ PC (Sprint F8a-F8d) (+11 more)
...
Cohesion: 0.25
Nodes (6): Decision Log, Example, Feynman explanation, Layman analogy, Decision Log, Decision Log
...
Cohesion: 0.11
Nodes (15): Active Context, Active Context — Current Focus, Active Patterns and Preferences, Current Focus, Current Phase, Current Work, Next Steps, Open Questions / Checks (+7 more)
...
Cohesion: 0.25
Nodes (9): Skill: Code Review, Steps, When to Use, Code Review Skill, Code Review Skill, Purpose, Steps, Reviewer Agent (+1 more)
...
Cohesion: 0.36
Nodes (7): Cross-Analysis: v3.0 -> v4.0, Doctrine, Files Changed from v3, New Files in v4, Summary, Gemini/Jules Instructions (v4.0), Cross-Analysis: v3.0 -> v4.0
...
Cohesion: 0.50
Nodes (4): Claude Code Instructions (v4.0), Current Session State, Copilot Instructions, Universal Agent Instructions (v4.0)
...
## Knowledge Gaps
- **16412 isolated node(s):** `name`, `image`, `extensions`, `editor.formatOnSave`, `editor.tabSize` (+16407 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1000 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `UNGASIS Content Module: AI Operating Model` connect `AI Usage Protocols` to `Community 225`, `Community 2147`, `Decision Matrix Guide`, `Data and Cost Monitoring`, `Community 214`, `Context Loop Workflows`?**
...
- **What connects `name`, `image`, `extensions` to the rest of the system?**
  _16429 weakly-connected nodes found - possible documentation gaps or missing edges._

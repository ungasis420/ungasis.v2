...
## Corpus Check
- 1813 files · ~1,342,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30678 nodes · 33138 edges · 4094 communities (2997 shown, 1097 thin omitted)
...
## Communities (4094 total, 1097 thin omitted)
...
Cohesion: 0.05
Nodes (39): 11. Human Approval Gates, Approval template, 10. Human Approval Gates, 0. Quick Start, 10. AI Quality Control, 11. Human Approval Gates, 13. Daily AI Usage Checklist, 14. Beginner Mistakes to Avoid (+31 more)
...
Cohesion: 0.09
Nodes (20): 0. Beginner Promise, 1. Important Safety Rule, 2. Fast Router, 3. Quick Feature Matrix, 5. Beginner Decision Rules, 6. Copy-Paste Master Router Prompt, 7. Source Ledger, 8. QA Checklist for This Module (+12 more)
...
Cohesion: 0.06
Nodes (35): 10. How to Separate Free vs. Paid Features, 11. Pricing Research Basics, 12. Tax and Legal General Caution, 1. When NOT to Monetize Yet, 2. How to Validate Willingness to Pay — WITHOUT Building Payments, 3. $0-Upfront Revenue Tests — 10 Methods, 4. Payment Options Table, 5. Philippines-Specific Monetization Notes (+27 more)
...
Cohesion: 0.08
Nodes (30): UNGASIS Router, Behavior, Rigor, and Systems, UNGASIS Engine Kernel, UNGASIS Framework Kernel, UNGASIS Intelligence Kernel, UNGASIS Guardrails, UNGASIS Templates, UNGASIS Regression Tests, Depth Modes (+22 more)
...
Cohesion: 0.14
Nodes (15): Behaviour, Purpose, Subagent: Codebase Mapper, Behaviour, Purpose, Subagent: Reviewer, Available Subagents, Rules (+7 more)
...
Cohesion: 0.12
Nodes (16): 11. How to Avoid Exposing Secrets and Company Data, 12. Free Hosting Options for Portfolio, 13. How to Write About Projects for LinkedIn, 14. SEO Basics for Portfolio, 8. How to Create Short Demo Video Scripts, Free Video Tools, If You Already Pushed a Secret to GitHub, LinkedIn Post Template (+8 more)
...
Cohesion: 0.11
Nodes (18): 1. Why You Need a Portfolio, 2. How to Turn a Personal Tool → Portfolio Project, 3. What to Show Publicly vs. Keep Private, 5. How to Create a Demo Dataset, 6. How to Write a Beginner-Friendly README, Add your Supabase keys to .env.local, Before vs. After, Copy-Paste README Template (+10 more)
...
Cohesion: 0.10
Nodes (20): 1. Why You Need a Portfolio, 2. How to Turn a Personal Tool → Portfolio Project, 3. What to Show Publicly vs. Keep Private, 4. How to Use Dummy/Demo Data Safely, 5. How to Create a Demo Dataset, 6. How to Write a Beginner-Friendly README, Before vs. After, ChatGPT Prompt for Demo Data (+12 more)
...
Cohesion: 0.18
Nodes (11): Files, Template Manifest, v5 additions, AI Project OS Master v5 llms.txt, AI Project OS Master v5 README, Files, Template Manifest, v5 additions (+3 more)

### Community 189 - "Architecture and Data Flow"
Cohesion: 0.20
Nodes (15): Architecture Map, Architecture, Architecture principle, Chosen stack, Current stage, Data model, Layers, Reversal path (+7 more)
...
Cohesion: 0.07
Nodes (29): 1. What Is the Gold Skeleton?, 2. The Status System, 3. Data Level Reference, 4. How to Read the Skeleton, 5. The Full Gold Skeleton, 6. Status Summary Dashboard, 7. What to Build First — Top 10 for Beginners, 8. Stage Progression Guide (+21 more)
...
Cohesion: 0.11
Nodes (17): Agent Evals & Runtime Governance Module, UNGASIS Quick Reference Wiki Guide, Claude Code Instructions (CLAUDE.md), UNGASIS Unified Builder's Wiki, Agent Scoring Configuration, Agent State Machine Workflow, Chain, Multi-Agent Dev Orchestration Kit v4.0 (+9 more)
...
Cohesion: 0.12
Nodes (21): int, estimate_tokens(), main(), str, Compaction Triggers, Context Budget (v4.0 - NEW), Estimation, Fill-% Budget Zones (+13 more)
...
Cohesion: 0.20
Nodes (13): Feynman explanation, Layman analogy, Original compact protocol, Revised active protocol, Shared State Protocol, Feynman explanation, Layman analogy, Original compact protocol (+5 more)
...
Cohesion: 0.07
Nodes (27): 10. What to Do First If a Platform Goes Down — Emergency Card, 11. The UNGASIS Backup Checklist, 1. Why Backups Matter, 2. What to Backup Regularly, 4. Vendor Lock-In Risk Assessment, 5. What Happens If Free Tier Becomes Paid, 8. Backup Schedule Recommendation, 🤖 AI & Prompts (+19 more)
...
Cohesion: 0.11
Nodes (18): 11. How to Avoid Exposing Secrets and Company Data, 12. Free Hosting Options for Portfolio, 13. How to Write About Projects for LinkedIn, 14. SEO Basics for Portfolio, 7. How to Create Screenshots and Annotated Walkthroughs, Add your Supabase keys to .env.local, Annotation Tips, Free Tools for Screenshots (+10 more)
...
Cohesion: 0.29
Nodes (10): 1. Memory Dimension, 2. Knowledge Dimension, 3. Knowledge Conflict Resolution, 5. Rigor-Aware Guardrails, 6. Knowledge Update Note, Knowledge Routing Rules, Memory Capture Template, Memory Rule (+2 more)
...
Cohesion: 0.23
Nodes (11): Cross-Reference Bridge, Cross-Reference Bridge, Feynman explanation, Layman analogy, Feynman explanation, Layman analogy, Model Routing v4.1, Original compact routing (+3 more)
...
Cohesion: 0.12
Nodes (13): Context Decay Protocol (Layer 16), Key Commands, Read First, Rules, UNGASIS OS — Claude Code Instructions, Cline Claude Config, UNGASIS OS v4.0, Last Session Summary (+5 more)
...
Cohesion: 0.07
Nodes (24): Active Context, Current Status, Evolution of Decisions, Known Issues, Next Validation Step, Progress — Status and Milestones, What's Left To Build, What Works (+16 more)
...
Cohesion: 0.36
Nodes (11): generate_report(), get_git_status(), get_last_session(), get_projects(), get_queue_status(), get_scout_discoveries(), get_staleness(), get_warnings() (+3 more)
...
Cohesion: 0.70
Nodes (4): get_time_block(), main(), parse_duration(), parse_time()
...
Cohesion: 0.28
Nodes (8): Check quality-log.md has expected table format., Calculate the quality score of a markdown file.      Args:         filepath (str, Print command-line usage information., Walk .ungasis/ and score every markdown file., run_batch_scoring(), score_file(), show_usage(), validate_quality_log()
...
Cohesion: 0.42
Nodes (8): fetch_feed_items(), find_elements_by_tag(), get_child_attr(), get_child_text(), main(), parse_date(), parse_sources(), today_str_placeholder()

### Community 2743 - "Community 2743"
Cohesion: 0.46
Nodes (7): fetch_youtube_videos(), find_elements_by_tag(), get_child_attr(), get_child_text(), main(), parse_date(), parse_sources()
...
Cohesion: 0.67
Nodes (3): check_warnings(), Check warning-log.md has expected table format., validate_warning_log()
...
Cohesion: 0.57
Nodes (6): cmd_backup(), cmd_health(), cmd_test(), cmd_version(), main(), run_script()
...
Cohesion: 0.43
Nodes (4): main(), test_file_exists(), test_queue_format(), test_script_runs()
...
Cohesion: 0.29
Nodes (8): Skill: Code Review, Steps, When to Use, Subagent: Reviewer, Skill: Code Review, Behaviour, Purpose, Subagent: Reviewer
...
Cohesion: 0.29
Nodes (6): 1.0-2.x lineage, 3.0-master - 2026-06-01, 4.0 - Additional video coverage patch, Changelog, v5 - Master merge with Karpathy Knowledge Base coverage, UNGASIS Quick Reference Wiki Guide
...
- **1097 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `UNGASIS Content Module: AI Operating Model` connect `AI Usage Protocols` to `Community 225`, `Community 2626`, `Data and Cost Monitoring`, `Community 214`, `AI Operating Model`, `Context Loop Workflows`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `UNGASIS AI Operating Model` connect `Data and Cost Monitoring` to `AI Usage Protocols`, `Community 702`?**

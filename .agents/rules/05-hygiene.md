...
Use this rule to keep `.clinerules/`, `CLAUDE.md`, Memory Bank files, and `MEMORY.md` fresh, non-conflicting, and lean.
...
| 5 | 🌐 Cross-tool files | `CLAUDE.md`, `GEMINI.md`, root instructions |
...
| Step | Action | Output |
|---|---|---|
| 1. Inventory | List `.clinerules/*.md`, `CLAUDE.md`, Memory Bank, and root memory files | File list |
...
| Find repeated warnings | `grep -R "Never expose secrets" .clinerules/ CLAUDE.md` |

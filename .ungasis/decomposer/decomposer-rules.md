...
## How It Works
When a task is loaded, the Decomposer analyzes the file count and complexity. If the task is larger than medium size, it splits the goal into smaller tasks. It assigns an agent to each task and outputs a decomposition sheet.

...
- **Outputs**: OKR progress tables, status metrics, and at-risk alerts in the daily pulse.

## Example OKR
- **Objective**: Ship RiftCoach MVP by August 2026
- **Key Results**:
  - **KR1**: Build Engine complete with 10 champion builds (current: 0/10)
  - **KR2**: AI coaching generates helpful rationale for 90% of builds (current: 60%)
